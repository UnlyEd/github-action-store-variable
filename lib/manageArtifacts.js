...
const storeArtifact = (variables, failOnUnreachable) => __awaiter(void 0, void 0, void 0, function* () {
...
const retrieveArtifact = (variables, failOnUnreachable) => __awaiter(void 0, void 0, void 0, function* () {
    const client = artifact.create();
    rimraf_1.default.sync(config_1.WORKDIR);
    fs_1.mkdirSync(config_1.WORKDIR);
    for (const variable of variables) {
...
const manageArtifacts = (variables, delimiter, failOnUnreachable) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield storeArtifact(variablesDetail.filter((variable) => variable.operationToProceed === 0)
        .map((variable) => variable.detail), failOnUnreachable);
